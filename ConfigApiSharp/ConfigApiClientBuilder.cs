...
{
    /// <summary>
    /// Deprecated. Use <see cref="ClientFactory.BuildConfigApiClient"/>.
    /// </summary>
    public static class ConfigApiClientBuilder
    {
        /// <summary>
        /// Deprecated. Use <see cref="ClientFactory.BuildConfigApiClient"/>. Builds a WCF channel using the <see cref="IConfigurationService"/> interface defined by the Management Server. The raw ConfigurationService channel is returned in the Client property of the BuildClientResponse object.
        /// </summary>
